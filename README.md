...
It uses [Equalizer APO](https://equalizerapo.com/) as the persistent attenuation backend. Once a limit is configured, Equalizer APO keeps applying it even when Audio Limits itself is not open.
